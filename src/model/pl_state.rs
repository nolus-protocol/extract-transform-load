...
pub struct PL_State {
    ...
    pub PL_LS_count_open: UInt63,
    pub PL_LS_count_closed: UInt63,
    pub PL_LS_count_opened: UInt63,
    pub PL_IN_LS_cltr_amnt_opened_stable: BigDecimal,
    pub PL_LP_count_open: UInt63,
    pub PL_LP_count_closed: UInt63,
    pub PL_LP_count_opened: UInt63,
