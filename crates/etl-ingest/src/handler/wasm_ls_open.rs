...
pub async fn parse_and_insert(
    ...
    let ls_loan_amnt = match lease_state.into_opened() {
        Some(opened) => opened.amount.amount,
        None => String::from("0"),
    };
    ...
    let ls_opening = LS_Opening {
        ...
        LS_loan_amnt: ls_loan_amnt,
        LS_interest: air,
        LS_timestamp: at,
        LS_loan_pool_id: item.loan_pool_id.to_owned(),
        LS_loan_amnt_stable: ls_loan_amnt_stable,
        ...
        LS_lpn_loan_amnt: ls_lpn_loan_amnt,
